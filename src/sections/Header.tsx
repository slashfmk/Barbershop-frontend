...
import { FaAppStore, FaPlaystation, FaGlobeAmericas, FaPlusCircle, FaMemory } from "react-icons/fa";
...
<div className=" justify-self-end self-center hidden sm:inline">
    {
        !auth?.user ?
            ...
            <div className="flex flex-col place-items-center justify-center my-auto">
                <h1 className="text-5xl text-center md:text-7xl text-transparent mb-12 font-extrabold bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text">
                    Best version of you!
                </h1>
